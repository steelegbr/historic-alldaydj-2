Public Class frmAddToRotation

    Private Sub frmAddToRotation_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        If (Me.rbSpot.Checked) Then
            ...
            frmEditRotation.addToRotation(ProgramSettings.spots(selected_item))
        ...
        Else
            ...
            frmEditRotation.addToRotation(ProgramSettings.playlists(selected_item))
