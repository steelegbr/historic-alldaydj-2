...
Public Class Database
    ...
    Public Function execute(ByVal query As String) As Boolean
        ...
        Try
            ...
            'MsgBox("===Database Query===" & vbCrLf & vbCrLf & query) ' DEBUG BUILD
    ...
    Public Function executeRS(ByVal query As String) As OleDbDataReader
        ...
        Catch ex As Exception
            'MsgBox("A database error ocurred." & Chr(13) & Chr(10) & "Description: " & ex.Message & Chr(13) & Chr(10) & "SQL Query: " & query, MsgBoxStyle.Exclamation, "Error") ' REMOVE ERROR DEBUG
            Return Nothing
        End Try
