Public Class ProgramSettings
    ...
    Shared days_of_week() As String = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"}
    ...
    Public Shared Property record_collection_location() As String
        ...
        End Set
    End Property
    Public Shared ReadOnly Property day_of_week(ByVal index As Integer)
        Get
